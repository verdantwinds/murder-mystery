public class Weapon extends Item {
    public static final Weapon KNIFE = new Weapon("Knife", "A sharp kitchen knife with a wooden handle", "assets/Knife.png", 0, 0);
    ...
    public static final Weapon PLASTIC_BAG = new Weapon("Plastic Bag", "A small bag for life", "assets/PlasticBag.png", 0, 0);
